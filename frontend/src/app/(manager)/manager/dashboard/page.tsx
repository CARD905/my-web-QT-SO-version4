...
function DashboardContent({ data }: { data: DashboardData }) {
  ...
  const totalDecided = data.totals.approved + data.totals.rejected;
  const approvalRate = totalDecided > 0
    ? Math.round((data.totals.approved / totalDecided) * 100) : 0;

  const todayTotal = data.todayActivity.approved + data.todayActivity.rejected;
  const todayRate = todayTotal > 0
    ? Math.round((data.todayActivity.approved / todayTotal) * 100) : null;
  ...
  const monthRate = monthTotal > 0
    ? Math.round((monthApproved / monthTotal) * 100) : null;
  ...
  return (
    <>
      ...
      {/* ── Approval Activity (วันนี้ / เดือนนี้ / ทั้งหมด) ── */}
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
        ...
        <CardContent>
          <div className="grid grid-cols-3 divide-x divide-border">
            {/* วันนี้ */}
            <div className="px-4 first:pl-0 space-y-3">
              ...
              <div className="flex gap-4">
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xl font-bold">{data.todayActivity.approved}</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xl font-bold">{data.todayActivity.rejected}</span>
                  </div>
            ...
            <div className="px-4 space-y-3">
              ...
              <div className="flex gap-4">
                <div>
                  <div className="flex items-center gap-1">
                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" />
                    <span className="text-xl font-bold">{monthApproved}</span>
                  </div>
                  <div className="text-[10px] text-muted-foreground">Approved</div>
                </div>
                <div>
                  <div className="flex items-center gap-1">
                    <XCircle className="h-3.5 w-3.5 text-red-500" />
                    <span className="text-xl font-bold">{monthRejected}</span>
                  </div>
                  <div className="text-[10px] text-muted-foreground">Rejected</div>
                </div>
              </div>
            ...
            <div className="px-4 space-y-3">
              ...
              <div className="flex gap-4">
                <div>
                  <div className="flex items-center gap-1">
                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" />
                    <span className="text-xl font-bold">{data.totals.approved}</span>
                  </div>
                  <div className="text-[10px] text-muted-foreground">Approved</div>
                </div>
                <div>
                  <div className="flex items-center gap-1">
                    <XCircle className="h-3.5 w-3.5 text-red-500" />
                    <span className="text-xl font-bold">{data.totals.rejected}</span>
                  </div>
                  <div className="text-[10px] text-muted-foreground">Rejected</div>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* Team Overview — แทน Top Officers */}
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm flex items-center gap-2">
          ...
          <CardContent>
            {data.topOfficers.length === 0 ? (
              ...
              <div className="space-y-2">
                {/* Header */}
                <div className="grid grid-cols-4 text-[10px] text-muted-foreground uppercase px-2 pb-1 border-b">
                  <span className="col-span-2">ชื่อ</span>
                  <span className="text-center">QT ทั้งหมด</span>
